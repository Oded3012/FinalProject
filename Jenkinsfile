node('built-in') {
    ...
    stage('Push To Nexus Registry') {
        sh 'docker login -u admin -p oded3012 https://100.26.148.96:8082/repository/nio'
        sh 'docker tag hello-world-war:$BUILD_ID https://100.26.148.96:8081/repository/nio/v2/Hello-World:$BUILD_ID'
        sh 'docker push https://100.26.148.96:8081/repository/nio/v2/Hello-World:$BUILD_ID'
    }
}
